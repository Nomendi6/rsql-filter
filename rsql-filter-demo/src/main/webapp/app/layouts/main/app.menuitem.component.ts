    ...
    <ng-container>
      <a
        ...
        *ngIf="!item.routerLink || item.items"
        ...
        [attr.tabindex]="0"
        [ngClass]="item.class"
        [attr.data-automationid]="item.automationId || item.routerLink"
      >
        <span class="menuitem-text">{{ item.label }}</span>
        <em class="pi pi-fw pi-angle-down layout-submenu-toggler" *ngIf="item.items"></em>
      ...
      >
        <ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
          <li jhi-menuitem [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass"></li>
        </ng-template>
      </ul>
    </ng-container>
  `,
