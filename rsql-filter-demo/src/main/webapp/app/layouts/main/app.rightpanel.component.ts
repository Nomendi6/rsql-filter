        ...
        <div class="right-panel-content-row">
          <div class="tasks">
            <div class="tasks-header">
              ...
              <div class="tasks-info"><span>You have</span><span class="highlighted"> 2 tasks</span><span> today</span></div>
            </div>
            <ul class="tasks-list">
          ...
          <div class="weather">
            ...
            <ul class="weather-list">
              <li class="weather-list-item">
                ...
                <div class="weather-info">
                  <div class="weather-icon icon-1">
                    <img src="content/layout/images/rightpanel/weather-icon-1.svg" alt="mirage-layout" />
                  </div>
              ...
              <li class="weather-list-item">
                ...
                <div class="weather-info">
                  <div class="weather-icon icon-2">
                    <img src="content/layout/images/rightpanel/weather-icon-3.svg" alt="mirage-layout" />
                  </div>
              ...
              <li class="weather-list-item">
                ...
                <div class="weather-info">
                  <div class="weather-icon icon-1">
                    <img src="content/layout/images/rightpanel/weathericon-4.svg" alt="mirage-layout" />
                  </div>
              ...
              <li class="weather-list-item">
                ...
                <div class="weather-info">
                  <div class="weather-icon icon-3">
                    <img src="content/layout/images/rightpanel/weather-icon-4.svg" alt="mirage-layout" />
                  </div>
                  <div class="weather-value">31°</div>
                </div>
              </li>
