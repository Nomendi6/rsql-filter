...
// Navbar
export const navbarSelector = '[data-cy="menu-container"]';
export const adminMenuSelector = '[data-automationid="adminMenu"]';
export const accountMenuSelector = '[data-automationid="accountMenu"]';
export const registerItemSelector = '[data-automationid="register"]';
export const settingsItemSelector = '[data-automationid="settings"]';
export const passwordItemSelector = '[data-automationid="passwordItem"]';
export const loginItemSelector = '[data-automationid="login"]';
export const logoutItemSelector = '[data-automationid="logout"]';
export const entityItemSelector = '[data-automationid="entity"]';
...
declare global {
  namespace Cypress {
    interface Chainable {
      authenticatedRequest(data: { method?: string; body?: { username: string; password: string }; url: string }): Cypress.Chainable;
