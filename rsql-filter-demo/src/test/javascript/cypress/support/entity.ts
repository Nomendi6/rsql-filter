...
Cypress.Commands.add('getEntitySaveButton', (entityInstanceName: string) => {
  return cy.get(`[data-cy="${entityInstanceName}SaveButton"]`);
});

Cypress.Commands.add('getEntityRefreshButton', (entityInstanceName: string) => {
  return cy.get(`[data-cy="${entityInstanceName}RefreshButton"]`);
});

Cypress.Commands.add('getEntityCreateButton', (entityInstanceName: string) => {
  return cy.get(`[data-cy="${entityInstanceName}CreateButton"]`);
});

Cypress.Commands.add('getEntityHelpButton', (entityInstanceName: string) => {
  return cy.get(`[data-cy="${entityInstanceName}HelpButton"]`);
});

Cypress.Commands.add('getEntityDeleteButton', (entityInstanceName: string) => {
  return cy.get(`[data-cy="${entityInstanceName}DeleteButton"]`);
});

Cypress.Commands.add('getEntityConfirmDeleteButton', (entityInstanceName: string) => {
  return cy.get(`[data-cy="${entityInstanceName}ConfirmDeleteButton"]`);
});

Cypress.Commands.add('getEntitySearchInput', (entityInstanceName: string) => {
  return cy.get(`[data-cy="${entityInstanceName}SearchInput"]`);
});

Cypress.Commands.add('getEntityTableRows', (entityInstanceName: string) => {
  return cy.get(`[data-cy^="${entityInstanceName}TableRow_"]`);
});

Cypress.Commands.add('getEntityTableRow', (entityInstanceName: string, id: string | number) => {
  return cy.get(`[data-cy="${entityInstanceName}TableRow_${id}"]`);
});
...
declare global {
  namespace Cypress {
    interface Chainable {
      ...
      getEntitySaveButton(entityInstanceName: string): Cypress.Chainable;
      getEntityRefreshButton(entityInstanceName: string): Cypress.Chainable;
      getEntityCreateButton(entityInstanceName: string): Cypress.Chainable;
      getEntityHelpButton(entityInstanceName: string): Cypress.Chainable;
      getEntityDeleteButton(entityInstanceName: string): Cypress.Chainable;
      getEntityTableRows(entityInstanceName: string): Cypress.Chainable;
      getEntityTableRow(entityInstanceName: string, id: string | number): Cypress.Chainable;
      getEntityConfirmDeleteButton(entityInstanceName: string): Cypress.Chainable;
      getEntitySearchInput(entityInstanceName: string): Cypress.Chainable;
