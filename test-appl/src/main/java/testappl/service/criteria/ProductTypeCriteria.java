...
/**
 * Criteria class for the {@link testappl.domain.ProductType} entity. This class is used
 * in {@link testappl.web.rest.ProductTypeResource} to receive all the possible filtering options from
...
public class ProductTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, seq, status, validFrom, validUntil, distinct);
    }
