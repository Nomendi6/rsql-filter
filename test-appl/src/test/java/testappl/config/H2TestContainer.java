...
public class H2TestContainer implements SqlTestContainer {
    ...
    private static final String H2_JDBC_URL = "jdbc:h2:mem:testappl;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;MODE=LEGACY";
    private static final String H2_USERNAME = "testappl";
